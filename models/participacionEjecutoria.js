module.exports = (sequelize, Sequelize, Participacion, Ejecutoria, Comisionado) => {

  const ParticipacionEjecutoria = sequelize.define('participaciones_ejecutorias', {
    id: {
    ...
    idEjecutoria: { type: Sequelize.INTEGER, references: {
      model: Oferta,
      key: 'id'
    }},
  ...
  return ParticipacionEjecutoria;
